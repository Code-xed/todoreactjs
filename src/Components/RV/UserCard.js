...
function UserCard() {
  return (
    <div className="break-normal h-screen overflow-hidden flex items-center justify-center shadow-lg shadow-blue-600">
      <div className="flex items-center justify-center h-screen">
        <div className="from-slate-700 bg-gradient-to-r to-blue-600 font-bold text-center rounded-3xl border shadow-lg p-10 max-w-xs">
          ...
          <button className="select-none from-slate-800 bg-gradient-to-r to-slate-600 px-8 py-2 mt-8 rounded-3xl text-gray-100 font-semibold uppercase tracking-wide hover:from-red-700 hover:to-red-700 hover:text-slate-200">Hire Me</button>
        </div>
      </div>
    </div>
  );
